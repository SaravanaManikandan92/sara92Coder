...
/*	<CFIF LEN(SAVE_STUDENT_P_GPA) == 3>
    ...
    public String MID(String str, int start, int end) { //couldfusion starts with 1(yes)? include the end? the end is count(yes) or the pos?
        if( str==null||str.trim().isEmpty()||start<=0 ||end<=0) return "";
...
//        log.info("  getRoomAndBoard() got SAVE_STUDENT_W_DORM=%s", SAVE_STUDENT_W_DORM);
  ...
  //      log.info(" getPell() got SAVE_STUDENT_X_FAFSA=%s", SAVE_STUDENT_X_FAFSA);
    ...
    <CFOUTPUT
            ...
            <br />6)Asset: #SAVE_STUDENT_AE_FAMILY_ASSET#
    </CFOUTPUT
    **********/ 
    if( adjust_calgrant_amt_ind==true && std.getStudentZCalgrant().equalsIgnoreCase("yes")) return std.getStudentAaCalgrantA();//SAVE_STUDENT_AA_CALGRANT_A;    
    ...
    <CFOUTPUT
            ...
            <br />#SAVE_STUDENT_AE_FAMILY_ASSET#
    </CFOUTPUT
    **********/ 
    if( adjust_calgrant_amt_ind==true && std.getStudentZCalgrant().equalsIgnoreCase("yes") ) return std.getStudentAbCalgrantB();
    ...
    **********/ 
    ...
    <CFOUTPUT
            ...
            <br />_edAllowance1 = #getTuitionAndFees()-yFrOrientation# * #SAVE_STUDENT_AI_EDU_ALLOW_PER/100#
    </CFOUTPUT
    **********/ 
            ...
            if(  TRIM(SAVE_STUDENT_AH_LSU_ALLOWRANCE).equalsIgnoreCase("Yes")){
                    //if( std.getStudentAiEduAllowPer().compareTo(new BigDecimal(0))>0){// SAVE_STUDENT_AI_EDU_ALLOW_PER  > 0){
                            ...
                            if(  SAVE_STUDENT_U_ACADEMIC.equalsIgnoreCase("FR")){  //NPE ???????
                                ...
                                _edAllowance = (new BigDecimal(getTuitionAndFees()-yFrOrientation ).multiply(new BigDecimal(std.getEa_lsu_perc())).divide( new BigDecimal(100))  ).intValue();///100;
                            }else{
                                ...
                                _edAllowance =  new BigDecimal(getTuitionAndFees() ).intValue();///100;
                            }
                    //}else{
                    //         _edAllowance = 0;//"0){
                    //}
 ...
 //                          log.info("eaeaeaeaeeaea getExternalAllowance() std.getStudentAiEduAllowPer() > 0 while tuition_fees=%d", getTuitionAndFees());
    ...
    <CFOUTPUT
            ...
            <br />#SAVE_STUDENT_AK_NONCAL_GRANT#
    </CFOUTPUT
    **********/ 
    ...
    <CFOUTPUT
            ...
            <br />#SAVE_STUDENT_AM_OUT_SCHOLARSHIP_AMT#
    </CFOUTPUT
    **********/ 
...
* */
    ...
    **********/ 
    ...
    /**********  
    <CFOUTPUT
            <br />#SAVE_STUDENT_AU_SCHOLARSHIP1_AMT#
    </CFOUTPUT
    **********/ 
    ...
    **********/ 
    ...
    /**********  
    <CFOUTPUT
            <br />#SAVE_STUDENT_AX_SCHOLARSHIP2_AMT#
    </CFOUTPUT
    **********/ 
    ...
    **********/ 
    ...
    /**********  
    <CFOUTPUT
            <br />#SAVE_STUDENT_BA_SCHOLARSHIP3_AMT#
    </CFOUTPUT
    **********/ 
    ...
    **********/ 
    ...
    /**********  
    <CFOUTPUT
            <br />#SAVE_STUDENT_BD_SCHOLARSHIP4_AMT#
    </CFOUTPUT
    **********/ 
...
//################################################ count other 5 possible funds ???      
            ...
            if(  _lsuLimitSubtotal  > _lsuLimit ){
                ...
                if( scholarship_amt_1 <0)scholarship_amt_1=0;
                scholarship_amt_2   = 0;
                scholarship_amt_7   = 0;
                scholarship_amt_8   = 0;
                scholarship_amt_9   = 0;
            ...
            if(  _lsuLimitSubtotal  > _lsuLimit ){
                ...
                if( scholarship_amt_2 <0)scholarship_amt_2=0;
                scholarship_amt_7   = 0;
                scholarship_amt_8   = 0;
                scholarship_amt_9   = 0;
            }
            ...
            if(  _lsuLimitSubtotal  > _lsuLimit ){
                ...
                if( scholarship_amt_7 <0)scholarship_amt_7=0;
                scholarship_amt_8   = 0;
                scholarship_amt_9   = 0;
            }
            ...
            if(  _lsuLimitSubtotal  > _lsuLimit ){
                ...
                if( scholarship_amt_8 <0)scholarship_amt_8=0;
                scholarship_amt_9   = 0;
            }
            ...
            if(  _lsuLimitSubtotal  > _lsuLimit ){
                ...
                if( scholarship_amt_9 <0)scholarship_amt_9=0;
            }
...
//       log.info("--------- enforceOverallLimits() zeros   gov aid since use_need_ind <=0");
        ...
        fseogAmt = 0;
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( extAllowance<0) extAllowance=0;
 ...
 //       log.info("--------- enforceOverallLimits() counts in non-ca grant since use_need_ind>0");
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( nonCaGrantAmt<0) nonCaGrantAmt=0;
 ...
 //       log.info("--------- enforceOverallLimits() zeros non-ca grant since use_need_ind <= 0");
        nonCaGrantAmt = 0;
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( lsuAllowance<0) lsuAllowance=0;
 ...
 //       log.info("--------- enforceOverallLimits() counts in lasu_need_grant since use_need_ind>0");
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( lsuNeedGrant < 0) lsuNeedGrant = 0;
                     _reduceRemaining = reduceAid(12);
                    return  true;
            }            
    }else{
//        log.info("--------- enforceOverallLimits() zeros lasu_need_grant since use_need_ind <= 0");
 ...
 //       log.info("--------- enforceOverallLimits() counts in lasuGrantAmt since use_need_ind>0");
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( lasuGrantAmt < 0) lasuGrantAmt = 0;
...
//        log.info("--------- enforceOverallLimits() zeros lasu_need_grant since use_need_ind <= 0");
        lasuGrantAmt = 0;
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( familyDiscount < 0) familyDiscount = 0;
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( nationalMerit < 0) nationalMerit = 0;
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( lsuAchievement < 0) lsuAchievement = 0;
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( lsu4yRenewable < 0) lsu4yRenewable = 0;
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( churchMatch < 0) churchMatch = 0;
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( pacificCampMatch < 0) pacificCampMatch = 0;
 ...
 //   <CFOUTPUT
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( nonPacificCampMatch < 0) nonPacificCampMatch = 0;
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( litEvanMatch < 0) litEvanMatch = 0;
...
//      log.info("--------- enforceOverallLimits() counts in sub_load, perkins, and fws since use_need_ind>0");
            ...
            if(  _lsuOverallLimitCheck  > _lsuOverallLimit ){
                     ...
                     if( perkinsLoan < 0) perkinsLoan = 0;
 ...
 //     log.info("--------- enforceOverallLimits() zeros sub_load, perkins, and fws since use_need_ind <= 0");
  ...
  //                  if(use_need_ind<1)_efcAmount=0;
                    ...
                    if(  reducedAid ==false ){ ////// ????????????????????????????? nobody changes it
                    ...
                    if( unsubDirect < 0) unsubDirect = 0;                    
            }
  //  </CFOUTPUT
...
// perkinsLoan = getLoanAmtAfterOrigination(perkinsLoan);
 ...
 //       log.info("====== after init, sdaAward=%d", sdaAward);
        ...
        //========================
        if(std.getStudentUAcademic().equalsIgnoreCase("CJ")) enforceCJLimits();
...
//        log.debug(".....initAndShowPellGrantAmt() after maxout, got nationalMerit=%d, lsuAchievement=%d, lsu4yRenewable=%d", nationalMerit, lsuAchievement, lsu4yRenewable);
    ...
    public String showCalGrantA(){ 
        if(!SAVE_STUDENT_Z_CALGRANT.equalsIgnoreCase("YES"))return "n/a";
...
*/    
    ...
    **********/ 
    ...
    /**********  <h1>Continuing College</h1>**********/ 
            ...
            /**********  LSU Performance is only for undergraduates working on their 1st degree******/
            if(  !TRIM(SAVE_STUDENT_U_ACADEMIC).equalsIgnoreCase("FR")
              && !TRIM(SAVE_STUDENT_U_ACADEMIC).equalsIgnoreCase("F2")
              && !TRIM(SAVE_STUDENT_U_ACADEMIC).equalsIgnoreCase("SO")
              && !TRIM(SAVE_STUDENT_U_ACADEMIC).equalsIgnoreCase("JR")
