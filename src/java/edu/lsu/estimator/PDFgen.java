...
/*     */       
/* 169 */       String str = "", stmp = ""; int x = 0, amt = 0;
/*     */       try {
...
/* 237 */         if (!ref.isEmp(str)) { form.setField("pub_notes", str); }
/* 238 */         else { form.setField("pub_notes", "none"); }
/*     */         
/* 240 */         calc.init();
...
/* 267 */         if (amt > 0) setLineContent(form, line++, "Federal PELL Grant", str, null); 
...
/* 273 */         if (amt > 0) setLineContent(form, line++, "Cal Grant A", str, null); 
...
/* 279 */         if (amt > 0) setLineContent(form, line++, "Cal Grant B", str, null); 
...
/* 285 */         if (amt > 0) setLineContent(form, line++, "FSEOG", str, null); 
...
/* 291 */         if (amt > 0) setLineContent(form, line++, "External Educational Allowance", str, null); 
...
/* 325 */         if (amt > 0) setLineContent(form, line++, "La Sierra Educational Allowance", str, null); 
...
/* 331 */         if (amt > 0) setLineContent(form, line++, "SDA Award", str, null); 
...
/* 342 */         if (amt > 0) setLineContent(form, line++, "La Sierra Need Grant", str, null); 
...
/* 348 */         if (amt > 0) setLineContent(form, line++, "Family Discount", str, null); 
...
/* 354 */         if (amt > 0) setLineContent(form, line++, "National Merit Scholarship", str, null); 
...
/* 361 */         if (amt > 0) setLineContent(form, line++, "La Sierra Achievement Award", str, null); 
...
/* 367 */         if (amt > 0) setLineContent(form, line++, "La Sierra 4-year Renewable Scholarship", str, null); 
...
/* 373 */         if (amt > 0) setLineContent(form, line++, "La Sierra Univ. Grant", str, null); 
...
/* 471 */               if (amt > 0) setLineContent(form, line++, "Subsidized Direct Loan (borrow " + calc.showAmt(calc.getOrg_loan_amt_sub()) + ")", str, null); 
...
/* 478 */             if (amt > 0) setLineContent(form, line++, "Perkins Loan (borrow " + calc.showAmt(calc.getOrg_loan_amt_perkins()) + ")", str, null); 
...
/* 488 */               if (amt > 0) setLineContent(form, line++, "Unsubsidized Direct Loan (borrow " + calc.showAmt(calc.getOrg_loan_amt_unsub()) + ")", str, null); 
/* 489 */               subtot += pdf.getUnsubloan().intValue();
/*     */             } 
/*     */             
/* 492 */             if (subtot > 0) setLineContent(form, line++, "Loans Subtotal", null, ref.fmtMoney(Integer.valueOf(subtot))); 
/*     */           } 
...
/*     */       } 
/* 795 */       if (name != null) form.setField(fieldname, name); 
/* 796 */       if (val != null && !val.isEmpty()) form.setField(fieldval, val);
/*     */       
/*     */     
/*     */     }
...
/*     */     } finally {
/*     */       try {
/* 841 */         if (fic != null) fic.close(); 
/* 842 */         if (fis != null) fis.close(); 
