...
/*      */ @Table(name = "STUDENT")
/*      */ @XmlRootElement
/*      */ @NamedQueries({@NamedQuery(name = "Student.findAll", query = "SELECT s FROM Student s"), @NamedQuery(name = "Student.findPOPWID", query = "SELECT s FROM Student s where s.pickupInd=1 and s.studentALsuid= :lsuid and UPPER(s.studentBLastname) LIKE :ln and UPPER(s.studentCFirstname) LIKE :fn and s.studentDDob like :dob ORDER BY s.ddoe desc "), @NamedQuery(name = "Student.findPOPWOID", query = "SELECT s FROM Student s where s.pickupInd=1 and UPPER(s.studentBLastname) LIKE :ln and UPPER(s.studentCFirstname) LIKE :fn and s.studentDDob like :dob ORDER BY s.ddoe desc "), @NamedQuery(name = "Student.findPOPWIDwrecid", query = "SELECT s FROM Student s where s.pickupInd=1 and s.studentALsuid= :lsuid and UPPER(s.studentBLastname) LIKE :ln and UPPER(s.studentCFirstname) LIKE :fn and s.studentDDob like :dob and s.recid <> :recid ORDER BY s.ddoe desc "), @NamedQuery(name = "Student.findPOPWOIDwrecid", query = "SELECT s FROM Student s where s.pickupInd=1 and UPPER(s.studentBLastname) LIKE :ln and UPPER(s.studentCFirstname) LIKE :fn and s.studentDDob like :dob and s.recid <> :recid ORDER BY s.ddoe desc "), @NamedQuery(name = "Student.findByStudentFisy", query = "SELECT s FROM Student s WHERE s.studentFisy = :studentFisy"), @NamedQuery(name = "Student.findActiveStudentByFisyNupNdownDiff", query = "SELECT s FROM Student s WHERE s.studentFisy = :studentFisy and s.pickupInd=1 and ((s.dup=0 and s.ddown=0 and s.clientId = :clientId) or (s.estmNumb<0))   "), @NamedQuery(name = "Student.findInactiveStudentByFisyNupNdownDiff", query = "SELECT s FROM Student s WHERE s.studentFisy = :studentFisy and s.pickupInd=0 and s.dup=0 and s.ddown=0  and s.clientId = :clientId and s.prtTimes>0 "), @NamedQuery(name = "Student.findUploadedNonPrtStudentByFisy", query = "SELECT s FROM Student s WHERE s.studentFisy = :studentFisy and s.dup>0 and s.ddown=0  and s.clientId = :clientId  and s.prtTimes=0 "), @NamedQuery(name = "Student.findByActiveLsuid", query = "SELECT s FROM Student s WHERE s.studentFisy = :fisy and s.recid <> :recid and s.studentALsuid = :lsuid and s.pickupInd=1"), @NamedQuery(name = "Student.findByStudentALsuid", query = "SELECT s FROM Student s WHERE s.studentALsuid = :studentALsuid"), @NamedQuery(name = "Student.findByStudentBLastname", query = "SELECT s FROM Student s WHERE s.studentBLastname = :studentBLastname"), @NamedQuery(name = "Student.findByStudentCFirstname", query = "SELECT s FROM Student s WHERE s.studentCFirstname = :studentCFirstname"), @NamedQuery(name = "Student.findByStudentDDob", query = "SELECT s FROM Student s WHERE s.studentDDob = :studentDDob"), @NamedQuery(name = "Student.findByStudentEEmail", query = "SELECT s FROM Student s WHERE s.studentEEmail = :studentEEmail"), @NamedQuery(name = "Student.findByStudentFPhone", query = "SELECT s FROM Student s WHERE s.studentFPhone = :studentFPhone"), @NamedQuery(name = "Student.findByStudentGStreet", query = "SELECT s FROM Student s WHERE s.studentGStreet = :studentGStreet"), @NamedQuery(name = "Student.findByStudentHCity", query = "SELECT s FROM Student s WHERE s.studentHCity = :studentHCity"), @NamedQuery(name = "Student.findByStudentIState", query = "SELECT s FROM Student s WHERE s.studentIState = :studentIState"), @NamedQuery(name = "Student.findByStudentJZip", query = "SELECT s FROM Student s WHERE s.studentJZip = :studentJZip"), @NamedQuery(name = "Student.findByStudentKCountry", query = "SELECT s FROM Student s WHERE s.studentKCountry = :studentKCountry"), @NamedQuery(name = "Student.findByStudentLIntlStud", query = "SELECT s FROM Student s WHERE s.studentLIntlStud = :studentLIntlStud"), @NamedQuery(name = "Student.findByStudentMMarry", query = "SELECT s FROM Student s WHERE s.studentMMarry = :studentMMarry"), @NamedQuery(name = "Student.findByStudentNSda", query = "SELECT s FROM Student s WHERE s.studentNSda = :studentNSda"), @NamedQuery(name = "Student.findByStudentOLastSchool", query = "SELECT s FROM Student s WHERE s.studentOLastSchool = :studentOLastSchool"), @NamedQuery(name = "Student.findByStudentPGpa", query = "SELECT s FROM Student s WHERE s.studentPGpa = :studentPGpa"), @NamedQuery(name = "Student.findByStudentQSat", query = "SELECT s FROM Student s WHERE s.studentQSat = :studentQSat"), @NamedQuery(name = "Student.findByStudentRAct", query = "SELECT s FROM Student s WHERE s.studentRAct = :studentRAct"), @NamedQuery(name = "Student.findByStudentSMerit", query = "SELECT s FROM Student s WHERE s.studentSMerit = :studentSMerit"), @NamedQuery(name = "Student.findByStudentTMajor", query = "SELECT s FROM Student s WHERE s.studentTMajor = :studentTMajor"), @NamedQuery(name = "Student.findByStudentUAcademic", query = "SELECT s FROM Student s WHERE s.studentUAcademic = :studentUAcademic"), @NamedQuery(name = "Student.findByStudentVFamily", query = "SELECT s FROM Student s WHERE s.studentVFamily = :studentVFamily"), @NamedQuery(name = "Student.findByStudentWDorm", query = "SELECT s FROM Student s WHERE s.studentWDorm = :studentWDorm"), @NamedQuery(name = "Student.findByStudentXFafsa", query = "SELECT s FROM Student s WHERE s.studentXFafsa = :studentXFafsa"), @NamedQuery(name = "Student.findByStudentYIndept", query = "SELECT s FROM Student s WHERE s.studentYIndept = :studentYIndept"), @NamedQuery(name = "Student.findByStudentZCalgrant", query = "SELECT s FROM Student s WHERE s.studentZCalgrant = :studentZCalgrant"), @NamedQuery(name = "Student.findByStudentAaCalgrantA", query = "SELECT s FROM Student s WHERE s.studentAaCalgrantA = :studentAaCalgrantA"), @NamedQuery(name = "Student.findByStudentAbCalgrantB", query = "SELECT s FROM Student s WHERE s.studentAbCalgrantB = :studentAbCalgrantB"), @NamedQuery(name = "Student.findByStudentAcFamilySize", query = "SELECT s FROM Student s WHERE s.studentAcFamilySize = :studentAcFamilySize"), @NamedQuery(name = "Student.findByStudentAfFamilyContrib", query = "SELECT s FROM Student s WHERE s.studentAfFamilyContrib = :studentAfFamilyContrib"), @NamedQuery(name = "Student.findByStudentAgNonlsuAllowrance", query = "SELECT s FROM Student s WHERE s.studentAgNonlsuAllowrance = :studentAgNonlsuAllowrance"), @NamedQuery(name = "Student.findByStudentAhLsuAllowrance", query = "SELECT s FROM Student s WHERE s.studentAhLsuAllowrance = :studentAhLsuAllowrance"), @NamedQuery(name = "Student.findByStudentAiEduAllowPer", query = "SELECT s FROM Student s WHERE s.studentAiEduAllowPer = :studentAiEduAllowPer"), @NamedQuery(name = "Student.findByStudentAjHomeState", query = "SELECT s FROM Student s WHERE s.studentAjHomeState = :studentAjHomeState"), @NamedQuery(name = "Student.findByStudentAkNoncalGrant", query = "SELECT s FROM Student s WHERE s.studentAkNoncalGrant = :studentAkNoncalGrant"), @NamedQuery(name = "Student.findByStudentAlOutScholarships", query = "SELECT s FROM Student s WHERE s.studentAlOutScholarships = :studentAlOutScholarships"), @NamedQuery(name = "Student.findByStudentAmOutScholarshipAmt", query = "SELECT s FROM Student s WHERE s.studentAmOutScholarshipAmt = :studentAmOutScholarshipAmt"), @NamedQuery(name = "Student.findByStudentAnPubNotes", query = "SELECT s FROM Student s WHERE s.studentAnPubNotes = :studentAnPubNotes"), @NamedQuery(name = "Student.findByStudentAoPriNotes", query = "SELECT s FROM Student s WHERE s.studentAoPriNotes = :studentAoPriNotes"), @NamedQuery(name = "Student.findByStudentApSubLoans", query = "SELECT s FROM Student s WHERE s.studentApSubLoans = :studentApSubLoans"), @NamedQuery(name = "Student.findByStudentAqUnsubLoans", query = "SELECT s FROM Student s WHERE s.studentAqUnsubLoans = :studentAqUnsubLoans"), @NamedQuery(name = "Student.findByStudentArFws", query = "SELECT s FROM Student s WHERE s.studentArFws = :studentArFws"), @NamedQuery(name = "Student.findByStudentAsScholarship1Name", query = "SELECT s FROM Student s WHERE s.studentAsScholarship1Name = :studentAsScholarship1Name"), @NamedQuery(name = "Student.findByStudentAtScholarship1Note", query = "SELECT s FROM Student s WHERE s.studentAtScholarship1Note = :studentAtScholarship1Note"), @NamedQuery(name = "Student.findByStudentAuScholarship1Amt", query = "SELECT s FROM Student s WHERE s.studentAuScholarship1Amt = :studentAuScholarship1Amt"), @NamedQuery(name = "Student.findByStudentAvScholarship2Name", query = "SELECT s FROM Student s WHERE s.studentAvScholarship2Name = :studentAvScholarship2Name"), @NamedQuery(name = "Student.findByStudentAwScholarship2Note", query = "SELECT s FROM Student s WHERE s.studentAwScholarship2Note = :studentAwScholarship2Note"), @NamedQuery(name = "Student.findByStudentAxScholarship2Amt", query = "SELECT s FROM Student s WHERE s.studentAxScholarship2Amt = :studentAxScholarship2Amt"), @NamedQuery(name = "Student.findByStudentAyScholarship3Name", query = "SELECT s FROM Student s WHERE s.studentAyScholarship3Name = :studentAyScholarship3Name"), @NamedQuery(name = "Student.findByStudentAzScholarship3Note", query = "SELECT s FROM Student s WHERE s.studentAzScholarship3Note = :studentAzScholarship3Note"), @NamedQuery(name = "Student.findByStudentBaScholarship3Amt", query = "SELECT s FROM Student s WHERE s.studentBaScholarship3Amt = :studentBaScholarship3Amt"), @NamedQuery(name = "Student.findByStudentBbScholarship4Name", query = "SELECT s FROM Student s WHERE s.studentBbScholarship4Name = :studentBbScholarship4Name"), @NamedQuery(name = "Student.findByStudentBcScholarship4Note", query = "SELECT s FROM Student s WHERE s.studentBcScholarship4Note = :studentBcScholarship4Note"), @NamedQuery(name = "Student.findByStudentBdScholarship4Amt", query = "SELECT s FROM Student s WHERE s.studentBdScholarship4Amt = :studentBdScholarship4Amt"), @NamedQuery(name = "Student.findByStudentBeScholarship5Name", query = "SELECT s FROM Student s WHERE s.studentBeScholarship5Name = :studentBeScholarship5Name"), @NamedQuery(name = "Student.findByStudentBfScholarship5Note", query = "SELECT s FROM Student s WHERE s.studentBfScholarship5Note = :studentBfScholarship5Note"), @NamedQuery(name = "Student.findByStudentBgScholarship5Amt", query = "SELECT s FROM Student s WHERE s.studentBgScholarship5Amt = :studentBgScholarship5Amt"), @NamedQuery(name = "Student.findByStudentBhScholarship6Name", query = "SELECT s FROM Student s WHERE s.studentBhScholarship6Name = :studentBhScholarship6Name"), @NamedQuery(name = "Student.findByStudentBiScholarship6Note", query = "SELECT s FROM Student s WHERE s.studentBiScholarship6Note = :studentBiScholarship6Note"), @NamedQuery(name = "Student.findByStudentBjScholarship6Amt", query = "SELECT s FROM Student s WHERE s.studentBjScholarship6Amt = :studentBjScholarship6Amt"), @NamedQuery(name = "Student.findByStudentBkScholarship7Name", query = "SELECT s FROM Student s WHERE s.studentBkScholarship7Name = :studentBkScholarship7Name"), @NamedQuery(name = "Student.findByStudentBlScholarship7Note", query = "SELECT s FROM Student s WHERE s.studentBlScholarship7Note = :studentBlScholarship7Note"), @NamedQuery(name = "Student.findByStudentBmScholarship7Amt", query = "SELECT s FROM Student s WHERE s.studentBmScholarship7Amt = :studentBmScholarship7Amt"), @NamedQuery(name = "Student.findByStudentBnScholarship8Name", query = "SELECT s FROM Student s WHERE s.studentBnScholarship8Name = :studentBnScholarship8Name"), @NamedQuery(name = "Student.findByStudentBoScholarship8Note", query = "SELECT s FROM Student s WHERE s.studentBoScholarship8Note = :studentBoScholarship8Note"), @NamedQuery(name = "Student.findByStudentBpScholarship8Amt", query = "SELECT s FROM Student s WHERE s.studentBpScholarship8Amt = :studentBpScholarship8Amt"), @NamedQuery(name = "Student.findByStudentBqScholarship9Name", query = "SELECT s FROM Student s WHERE s.studentBqScholarship9Name = :studentBqScholarship9Name"), @NamedQuery(name = "Student.findByStudentBrScholarship9Note", query = "SELECT s FROM Student s WHERE s.studentBrScholarship9Note = :studentBrScholarship9Note"), @NamedQuery(name = "Student.findByStudentBsScholarship9Amt", query = "SELECT s FROM Student s WHERE s.studentBsScholarship9Amt = :studentBsScholarship9Amt"), @NamedQuery(name = "Student.findByStudentBtSupercounselor", query = "SELECT s FROM Student s WHERE s.studentBtSupercounselor = :studentBtSupercounselor"), @NamedQuery(name = "Student.findByStudentBwProgress", query = "SELECT s FROM Student s WHERE s.studentBwProgress = :studentBwProgress"), @NamedQuery(name = "Student.findByStudentBzUploaded", query = "SELECT s FROM Student s WHERE s.studentBzUploaded = :studentBzUploaded"), @NamedQuery(name = "Student.findByStudentCbBanner", query = "SELECT s FROM Student s WHERE s.studentCbBanner = :studentCbBanner"), @NamedQuery(name = "Student.findByStudentPassword", query = "SELECT s FROM Student s WHERE s.studentPassword = :studentPassword"), @NamedQuery(name = "Student.findByStudentTermStart", query = "SELECT s FROM Student s WHERE s.studentTermStart = :studentTermStart"), @NamedQuery(name = "Student.findByStudentTermEnd", query = "SELECT s FROM Student s WHERE s.studentTermEnd = :studentTermEnd"), @NamedQuery(name = "Student.findByStudentStudType", query = "SELECT s FROM Student s WHERE s.studentStudType = :studentStudType"), @NamedQuery(name = "Student.findByStudentQSatV", query = "SELECT s FROM Student s WHERE s.studentQSatV = :studentQSatV"), @NamedQuery(name = "Student.findByPickupInd", query = "SELECT s FROM Student s WHERE s.pickupInd = :pickupInd"), @NamedQuery(name = "Student.findByEstmNumb", query = "SELECT s FROM Student s WHERE s.estmNumb = :estmNumb"), @NamedQuery(name = "Student.findByStudentNumb", query = "SELECT s FROM Student s WHERE s.studentNumb = :studentNumb"), @NamedQuery(name = "Student.findByIndEfc", query = "SELECT s FROM Student s WHERE s.indEfc = :indEfc"), @NamedQuery(name = "Student.findByIndExcloans", query = "SELECT s FROM Student s WHERE s.indExcloans = :indExcloans"), @NamedQuery(name = "Student.findByIndEalsu", query = "SELECT s FROM Student s WHERE s.indEalsu = :indEalsu"), @NamedQuery(name = "Student.findByIndEanonlsu", query = "SELECT s FROM Student s WHERE s.indEanonlsu = :indEanonlsu"), @NamedQuery(name = "Student.findByStudentAdFamilyIncome", query = "SELECT s FROM Student s WHERE s.studentAdFamilyIncome = :studentAdFamilyIncome"), @NamedQuery(name = "Student.findByStudentAeFamilyAsset", query = "SELECT s FROM Student s WHERE s.studentAeFamilyAsset = :studentAeFamilyAsset"), @NamedQuery(name = "Student.findByStudentByDom", query = "SELECT s FROM Student s WHERE s.studentByDom = :studentByDom"), @NamedQuery(name = "Student.findByStudentBvDoe", query = "SELECT s FROM Student s WHERE s.studentBvDoe = :studentBvDoe"), @NamedQuery(name = "Student.findByAdjCalgrantInd", query = "SELECT s FROM Student s WHERE s.adjCalgrantInd = :adjCalgrantInd"), @NamedQuery(name = "Student.findBySex", query = "SELECT s FROM Student s WHERE s.sex = :sex"), @NamedQuery(name = "Student.findByHomeAddrApt", query = "SELECT s FROM Student s WHERE s.homeAddrApt = :homeAddrApt"), @NamedQuery(name = "Student.findByHomecostudies", query = "SELECT s FROM Student s WHERE s.homecostudies = :homecostudies"), @NamedQuery(name = "Student.findByTzdoe", query = "SELECT s FROM Student s WHERE s.tzdoe = :tzdoe"), @NamedQuery(name = "Student.findByTzdom", query = "SELECT s FROM Student s WHERE s.tzdom = :tzdom"), @NamedQuery(name = "Student.findByTzup", query = "SELECT s FROM Student s WHERE s.tzup = :tzup"), @NamedQuery(name = "Student.findByTzdown", query = "SELECT s FROM Student s WHERE s.tzdown = :tzdown"), @NamedQuery(name = "Student.findByRecid", query = "SELECT s FROM Student s WHERE s.recid = :recid"), @NamedQuery(name = "Student.findByClientId", query = "SELECT s FROM Student s WHERE s.clientId = :clientId"), @NamedQuery(name = "Student.findByCounselorId", query = "SELECT s FROM Student s WHERE s.counselorId = :counselorId"), @NamedQuery(name = "Student.findByModRoot", query = "SELECT s FROM Student s WHERE s.modRoot = :modRoot"), @NamedQuery(name = "Student.findByModPre", query = "SELECT s FROM Student s WHERE s.modPre = :modPre"), @NamedQuery(name = "Student.findByStudentBxModCounselor", query = "SELECT s FROM Student s WHERE s.studentBxModCounselor = :studentBxModCounselor"), @NamedQuery(name = "Student.findByStudentBuOrigCounselor", query = "SELECT s FROM Student s WHERE s.studentBuOrigCounselor = :studentBuOrigCounselor"), @NamedQuery(name = "Student.findByCounselorOrig", query = "SELECT s FROM Student s WHERE s.counselorOrig = :counselorOrig"), @NamedQuery(name = "Student.findByCounselorMod", query = "SELECT s FROM Student s WHERE s.counselorMod = :counselorMod"), @NamedQuery(name = "Student.findByLostTz", query = "SELECT s FROM Student s WHERE s.lostTz = :lostTz"), @NamedQuery(name = "Student.findByStudentUserName", query = "SELECT s FROM Student s WHERE s.studentUserName = :studentUserName"), @NamedQuery(name = "Student.findActiveByLsuidOrUsernamewofisy", query = "SELECT s FROM Student s WHERE s.pickupInd = 1 and (s.studentALsuid = :lsuid or s.studentUserName = :username) "), @NamedQuery(name = "Student.findActiveByLsuidOrUsername", query = "SELECT s FROM Student s WHERE s.pickupInd = 1 and (s.studentALsuid = :lsuid or s.studentUserName = :username)  and s.studentFisy = :studentFisy"), @NamedQuery(name = "Student.findByDup", query = "SELECT s FROM Student s WHERE s.dup = :dup"), @NamedQuery(name = "Student.findByDdown", query = "SELECT s FROM Student s WHERE s.ddown = :ddown"), @NamedQuery(name = "Student.findByDdoe", query = "SELECT s FROM Student s WHERE s.ddoe = :ddoe"), @NamedQuery(name = "Student.findByDdom", query = "SELECT s FROM Student s WHERE s.ddom = :ddom"), @NamedQuery(name = "Student.findByLostTime", query = "SELECT s FROM Student s WHERE s.lostTime = :lostTime"), @NamedQuery(name = "Student.findByLostToMaster", query = "SELECT s FROM Student s WHERE s.lostToMaster = :lostToMaster"), @NamedQuery(name = "Student.findByLostToLocal", query = "SELECT s FROM Student s WHERE s.lostToLocal = :lostToLocal"), @NamedQuery(name = "Student.findByPrtTimes", query = "SELECT s FROM Student s WHERE s.prtTimes >0")})
...
/*  756 */   private Integer term_load4 = Integer.valueOf(0); @NotNull @DecimalMin("0.0") @DecimalMax("99.9")
...
/*      */     
/*  930 */     this.studentAuScholarship1Amt = Integer.valueOf(0); this.studentAxScholarship2Amt = Integer.valueOf(0); this.studentBaScholarship3Amt = Integer.valueOf(0);
/*  931 */     this.studentBdScholarship4Amt = Integer.valueOf(0); this.studentBgScholarship5Amt = Integer.valueOf(0); this.studentBjScholarship6Amt = Integer.valueOf(0);
/*  932 */     this.studentBmScholarship7Amt = Integer.valueOf(0); this.studentBpScholarship8Amt = Integer.valueOf(0); this.studentBsScholarship9Amt = Integer.valueOf(0);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
