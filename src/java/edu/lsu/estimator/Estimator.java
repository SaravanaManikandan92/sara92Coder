...
/*      */   @Inject
/*      */   InfoState info;
/*   80 */   private static final Logger log = LoggerFactory.getLogger(); @PersistenceContext
...
/*      */     } 
/*  371 */     this.std_sex1 = false; this.std_sex2 = false; this.std_sex3 = false;
/*  372 */     switch (this.std_sex) { case "F":
/*  373 */         this.std_sex1 = true; break;
/*  374 */       case "M": this.std_sex2 = true; break;
/*  375 */       case "N": this.std_sex3 = true; break; }
/*      */     
...
/*  389 */     this.std_merit1 = false; this.std_merit2 = false; this.std_merit3 = false;
/*  390 */     if (!this.ref.isEmp(this.std_merits))
/*  391 */       switch (this.std_merits) { case "MC":
/*  392 */           this.std_merit1 = true; break;
/*  393 */         case "MS": this.std_merit2 = true; break;
/*  394 */         case "MF": this.std_merit3 = true;
/*      */           break; }
/*      */        
...
/*  459 */     if (diffyear > 0 && this.ref.fundMaxOutIndById(prefunds[t].intValue()) < 0) this.stud.setStudentAuScholarship1Amt(Integer.valueOf(0)); 
...
/*  465 */     if (diffyear > 0 && this.ref.fundMaxOutIndById(prefunds[t].intValue()) < 0) this.stud.setStudentAxScholarship2Amt(Integer.valueOf(0)); 
...
/*  470 */     if (diffyear > 0 && this.ref.fundMaxOutIndById(prefunds[t].intValue()) < 0) this.stud.setStudentBaScholarship3Amt(Integer.valueOf(0)); 
...
/*  475 */     if (diffyear > 0 && this.ref.fundMaxOutIndById(prefunds[t].intValue()) < 0) this.stud.setStudentBdScholarship4Amt(Integer.valueOf(0)); 
...
/*  480 */     if (diffyear > 0 && this.ref.fundMaxOutIndById(prefunds[t].intValue()) < 0) this.stud.setStudentBgScholarship5Amt(Integer.valueOf(0)); 
...
/*  485 */     if (diffyear > 0 && this.ref.fundMaxOutIndById(prefunds[t].intValue()) < 0) this.stud.setStudentBjScholarship6Amt(Integer.valueOf(0)); 
...
/*  538 */     if (modStudent == null) return null; 
/*  539 */     this.modflag = 1;
...
/*  673 */         if (c == null) this.facesContext.getViewRoot().findComponent(uic_ids[i]); 
...
/*  716 */     if (!msg.isEmpty()) return null;
/*      */     
...
/*  757 */             if (this.facesContext != null) this.facesContext.addMessage(null, pdfmsg);
/*      */           
/*      */           } else {
/*  760 */             FacesMessage pdfmsg = this.ref.facesMessageByStr(FacesMessage.SEVERITY_ERROR, msg);
/*  761 */             if (this.facesContext != null) this.facesContext.addMessage(null, pdfmsg); 
...
/*  772 */           if (this.facesContext != null) this.facesContext.addMessage(null, pdfmsg); 
...
/*  778 */         if (this.facesContext != null) this.facesContext.addMessage(null, pdfmsg);
/*      */       
/*      */       } 
/*  781 */     } else if (!msg.equals("processed")) {
/*  782 */       FacesMessage guimsg = this.ref.facesMessageByStr(FacesMessage.SEVERITY_ERROR, msg);
/*  783 */       if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */     } 
/*  785 */     return null;
/*      */   }
/*      */   
...
/* 1109 */     if (recs == null || recs.size() == 0) return null;
/*      */     
...
/* 1165 */     if (recs == null || recs.size() == 0) return null;
/*      */     
...
/* 1225 */     if (!msg.isEmpty()) return null;
/*      */     
...
/* 1284 */           if (this.facesContext != null) this.facesContext.addMessage(null, pdfmsg); 
...
/* 1290 */         if (this.facesContext != null) this.facesContext.addMessage(null, pdfmsg);
/*      */       
/*      */       } 
/* 1293 */     } else if (!msg.equals("processed")) {
/* 1294 */       FacesMessage guimsg = this.ref.facesMessageByStr(FacesMessage.SEVERITY_ERROR, msg);
/* 1295 */       if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */     } 
/* 1297 */     return null;
/*      */   }
/*      */ 
...
/*      */       } 
/* 1332 */     }  pdf.setPrtTz(this.ref.getTzSN());
/*      */ 
/*      */     
...
/* 1349 */     if (pdfs == null) pdfs = new ArrayList<>(); 
/* 1350 */     pdfs.add(pdf);
...
/* 1369 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */         } 
/* 1371 */         miss++;
/*      */       } 
/*      */       
...
/* 1386 */         if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
...
/* 1405 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */         } 
/* 1407 */         miss++;
/*      */       } 
/*      */       
...
/* 1427 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
...
/* 1446 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */         } 
/* 1448 */         miss++;
/*      */       } 
/*      */     } else {
...
/* 1461 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */         } 
/* 1463 */         miss++;
/*      */       } 
/*      */     } else {
...
/* 1476 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */         } 
/* 1478 */         miss++;
/*      */       } 
/*      */     } else {
...
/* 1491 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */         } 
/* 1493 */         miss++;
/*      */       } 
/*      */     } else {
...
/* 1516 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg);
/*      */         
/*      */         } 
/*      */       } else {
...
/* 1526 */               if (this.facesContext != null) this.facesContext.addMessage(null, guimsg);
/*      */               
...
/* 1549 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
...
/* 1580 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */         } 
/*      */       } else {
...
/* 1589 */             if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
...
/* 1609 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
...
/* 1639 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
/*      */         } 
/*      */       } else {
...
/* 1647 */           if (np) {
/* 1648 */             if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
...
/* 1668 */           if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
...
/* 1700 */       if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
...
/* 1703 */       for (Iterator<Integer> iterator = map.keySet().iterator(); iterator.hasNext(); ) { int k = ((Integer)iterator.next()).intValue();
...
/*      */ 
/*      */     
/* 1807 */     if (this.stud.getNcStdInd() == null) this.stud.setNcStdInd(Integer.valueOf(0)); 
/* 1808 */     if (this.stud.getReturnStdInd() == null) this.stud.setReturnStdInd(Integer.valueOf(0));
/*      */ 
/*      */     
/* 1811 */     if (!pu) {
...
/* 1973 */         if (c == null) this.facesContext.getViewRoot().findComponent("std_lsuid");
/*      */         
...
/* 1981 */         if (this.facesContext != null) this.facesContext.addMessage("auth-sv-ptab-std_lsuid", err);
/*      */       
/*      */       } 
/*      */     } 
/* 1985 */     chk = validateLn(this.std_ln);
/* 1986 */     if (chk != 0) {
/* 1987 */       FacesMessage err; log.info("''''''''chkStudBasicInfo() validateLn(std_ln=%s)==%d", new Object[] { this.std_ln, Integer.valueOf(chk) });
/* 1988 */       if (chk < 0) {
...
/* 1997 */         if (c == null) this.facesContext.getViewRoot().findComponent("std_lname");
/*      */         
...
/* 2005 */         if (this.facesContext != null) this.facesContext.addMessage("auth-sv-ptab-std_lname", err); 
/*      */       } 
/*      */     } 
/* 2008 */     chk = validateFn(this.std_fn);
/* 2009 */     if (chk != 0) {
/* 2010 */       FacesMessage err; log.info("''''''''chkStudBasicInfo() validateFn(std_fn=%s)==%d", new Object[] { this.std_fn, Integer.valueOf(chk) });
/* 2011 */       if (chk < 0) {
...
/* 2020 */         if (c == null) this.facesContext.getViewRoot().findComponent("std_fname"); 
...
/* 2027 */         if (this.facesContext != null) this.facesContext.addMessage("auth-sv-ptab-std_fname", err); 
/*      */       } 
/*      */     } 
/* 2030 */     chk = validateDobStr(this.std_dob);
/* 2031 */     if (chk != 1) {
/* 2032 */       FacesMessage err; if (chk < 0) {
...
/* 2043 */         if (c == null) this.facesContext.getViewRoot().findComponent("std_dob"); 
...
/* 2051 */         if (this.facesContext != null) this.facesContext.addMessage("auth-sv-ptab-std_dob", err);
/*      */       
/*      */       } 
/*      */     } 
/*      */ 
...
/* 2161 */         if (c == null) this.facesContext.getViewRoot().findComponent("std_phone"); 
...
/* 2170 */         if (this.facesContext != null) this.facesContext.addMessage("auth-sv-ptab-std_phone", err);
/*      */       
/*      */       } 
/*      */     } 
/* 2174 */     return msg;
...
/* 2196 */         if (one.getStudentALsuid().equals(stud.getStudentALsuid()))
/* 2197 */           matches.add(one);  continue;
/*      */       } 
...
/* 2244 */     if (!msg.isEmpty()) return msg;
/*      */     
...
/*      */ 
/*      */     
/* 2298 */     if (this.stud.getStudentAuScholarship1Amt().intValue() > 0) this.stud.setStudentAuScholarship1Amt(Integer.valueOf(0));
/*      */ 
/*      */     
/* 2301 */     if (!msg.isEmpty()) {
/*      */       return;
...
/* 2389 */       if (this.facesContext != null) this.facesContext.addMessage(null, guimsg); 
...
/* 2419 */       if (this.facesContext != null) this.facesContext.addMessage(null, guimsg);
/*      */     
/*      */     } 
/*      */     
...
/* 2458 */       flen--;
/* 2459 */       if (str2.length() < flen) flen = str2.length(); 
...
/* 2615 */         this.std_indepts.size() == 0 && this.std_indept_byhand == 0) this.std_indept = false;
/*      */       
...
/* 2649 */       if (this.std_indepts.size() > 0) this.std_indept = true; 
/*      */     } 
...
/* 2749 */     if (firstxpos < 0)
/* 2750 */     { if (len < 7 || (len == 7 && (dotpos > 0 || blkpos > 0)) || (len == 8 && dotpos < 0 && blkpos < 0)) {
/* 2751 */         FacesMessage msg = this.ref.facesMessageByKey(FacesMessage.SEVERITY_ERROR, "EstimateForm.InvalidPhoneNumb");
/*      */         
/* 2753 */         if (this.facesContext != null) this.facesContext.addMessage(null, msg);  return;
/*      */       } 
...
/*      */       }  }
/* 2760 */     else { if (firstxpos < 7 || firstxpos != lastxpos || lastxpos == len - 1) {
/* 2761 */         FacesMessage msg = this.ref.facesMessageByKey(FacesMessage.SEVERITY_ERROR, "EstimateForm.InvalidPhoneNumb");
/*      */         
/* 2763 */         if (this.facesContext != null) this.facesContext.addMessage(null, msg); 
/*      */         return;
/*      */       } 
...
/*      */         
/* 2773 */         if (this.facesContext != null) this.facesContext.addMessage(null, msg);  return;
/*      */       } 
...
/*      */ 
/*      */       
/* 2789 */       if (this.facesContext != null) this.facesContext.addMessage(null, msg);
/*      */     
/*      */     } else {
/* 2792 */       matcher.reset();
...
/* 3210 */       if (phone == null || phone.isEmpty()) source.setValid(false);
/*      */       
/*      */       return;
/*      */     } 
...
/* 3234 */       if (firstxpos < 0)
/* 3235 */       { if (len < 7 || (len == 7 && (dotpos > 0 || blkpos > 0)) || (len == 8 && dotpos < 0 && blkpos < 0)) {
/* 3236 */           FacesMessage msg = this.ref.facesMessageByKey(FacesMessage.SEVERITY_ERROR, "EstimateForm.InvalidPhoneNumb");
/*      */           
/* 3238 */           if (this.facesContext != null) this.facesContext.addMessage(null, msg);  return;
/*      */         } 
...
/*      */         }  }
/* 3245 */       else { if (firstxpos < 7 || firstxpos != lastxpos || lastxpos == len - 1) {
/* 3246 */           FacesMessage msg = this.ref.facesMessageByKey(FacesMessage.SEVERITY_ERROR, "EstimateForm.InvalidPhoneNumb");
/*      */           
/* 3248 */           if (this.facesContext != null) this.facesContext.addMessage(null, msg); 
/*      */           return;
/*      */         } 
...
/*      */           
/* 3258 */           if (this.facesContext != null) this.facesContext.addMessage(null, msg);  return;
/*      */         } 
...
/*      */ 
/*      */         
/* 3274 */         if (this.facesContext != null) this.facesContext.addMessage(null, msg);
/*      */       
/*      */       } else {
/* 3277 */         matcher.reset();
...
/* 3332 */       if (firstxpos < 0)
/* 3333 */       { if (len < 7 || (len == 7 && (dotpos > 0 || blkpos > 0)) || (len == 8 && dotpos < 0 && blkpos < 0)) {
...
/* 3338 */         }  if (len == 7 && dotpos < 0 && blkpos < 0) {
...
/*      */         }  }
/* 3343 */       else { if (firstxpos < 7 || firstxpos != lastxpos || lastxpos == len - 1) {
...
/* 3358 */         }  if (len == 7 && dotpos < 0 && blkpos < 0) {
...
/* 3573 */     if (!this.std_efc) this.std_efc = true; 
...
/* 3753 */     if (superind > 0 || useramt <= fundmax) return 1;
/*      */ 
/*      */ 
/*      */     
...
/* 3769 */       if (this.facesContext != null) this.facesContext.addMessage(null, msg);
/*      */ 
/*      */ 
/*      */ 
/*      */       
...
/* 3792 */         if (this.facesContext != null) this.facesContext.addMessage(null, msg);
/*      */ 
/*      */ 
/*      */         
/*      */         return;
...
/* 3856 */       if (this.facesContext != null) this.facesContext.addMessage(null, msg);
/*      */       
/*      */       return;
/*      */     } 
...
/* 3878 */       if (this.facesContext != null) this.facesContext.addMessage(null, msg);
/*      */       
/*      */       return;
/*      */     } 
...
/* 3900 */       if (this.facesContext != null) this.facesContext.addMessage(null, msg);
/*      */       
/*      */       return;
/*      */     } 
...
/* 4225 */         if (this.std_indepts.size() == 0 && this.std_indept_byhand == 0) this.std_indept = false; 
/*      */       } 
...
/* 4287 */           switch (len) { case 4:
/* 4288 */               this.std_dob = "0" + dob[0] + "/0" + dob[1] + "/19" + dob[2] + dob[3]; break;
/*      */             case 5:
/* 4290 */               if (dob[0] > '1') { this.std_dob = "0" + dob[0] + "/" + dob[1] + dob[2] + "/19" + dob[3] + dob[4]; break; }
/* 4291 */                if (dob[1] <= '2') { this.std_dob = "" + dob[0] + dob[1] + "/0" + dob[2] + "/19" + dob[3] + dob[4]; break; }
/* 4292 */                this.std_dob = "0" + dob[0] + "/" + dob[1] + dob[2] + "/19" + dob[3] + dob[4]; break;
/*      */             case 6:
/* 4294 */               if (dob[0] == '0') {
/* 4295 */                 this.std_dob = "" + dob[0] + dob[1] + "/" + dob[2] + dob[3] + "/19" + dob[4] + dob[5]; break;
/* 4296 */               }  if (dob[0] == '1') {
/* 4297 */                 if (dob[1] >= '3') { this.std_dob = "0" + dob[0] + "/0" + dob[1] + "/" + dob[2] + dob[3] + dob[4] + dob[5]; break; }
/* 4298 */                  this.std_dob = "" + dob[0] + dob[1] + "/" + dob[2] + dob[3] + "/19" + dob[4] + dob[5]; break;
/* 4299 */               }  if (dob[0] > '1')
/* 4300 */                 this.std_dob = "0" + dob[0] + "/0" + dob[1] + "/" + dob[2] + dob[3] + dob[4] + dob[5]; 
/*      */               break;
/*      */             case 7:
/* 4303 */               if (dob[0] > '1') { this.std_dob = "0" + dob[0] + "/" + dob[1] + dob[2] + "/" + dob[3] + dob[4] + dob[5] + dob[6]; break; }
/* 4304 */                if (dob[1] >= '3') {
/* 4305 */                 this.std_dob = "0" + dob[0] + "/" + dob[1] + dob[2] + "/" + dob[3] + dob[4] + dob[5] + dob[6]; break;
/* 4306 */               }  this.std_dob = "" + dob[0] + dob[1] + "/0" + dob[2] + "/" + dob[3] + dob[4] + dob[5] + dob[6]; break;
/*      */             case 8:
...
/* 4327 */         if (day.length() == 1) day = "0" + day;
/*      */         
/* 4329 */         String month = matcher.group(1);
/* 4330 */         if (month.length() == 1) month = "0" + month;
/*      */         
...
/* 4562 */     if (this.ref.isEmp(ln)) return -1; 
/* 4563 */     String str = ln;
/*      */     
...
/* 4580 */     if (this.ref.isEmp(fn)) return -1; 
/* 4581 */     String str = fn;
/*      */     
...
/* 4605 */         if (this.std_indepts.size() == 0 && this.std_indept_byhand == 0) this.std_indept = false; 
/*      */       } 
...
/* 4703 */         switch (len) { case 4:
/* 4704 */             strdob = "0" + dob[0] + "/0" + dob[1] + "/19" + dob[2] + dob[3]; break;
/*      */           case 5:
/* 4706 */             if (dob[0] > '1') { strdob = "0" + dob[0] + "/" + dob[1] + dob[2] + "/19" + dob[3] + dob[4]; break; }
/* 4707 */              if (dob[1] <= '2') { strdob = "" + dob[0] + dob[1] + "/0" + dob[2] + "/19" + dob[3] + dob[4]; break; }
/* 4708 */              strdob = "0" + dob[0] + "/" + dob[1] + dob[2] + "/19" + dob[3] + dob[4]; break;
/*      */           case 6:
/* 4710 */             if (dob[0] == '0') {
/* 4711 */               strdob = "" + dob[0] + dob[1] + "/" + dob[2] + dob[3] + "/19" + dob[4] + dob[5]; break;
/* 4712 */             }  if (dob[0] == '1') {
/* 4713 */               if (dob[1] >= '3') { strdob = "0" + dob[0] + "/0" + dob[1] + "/" + dob[2] + dob[3] + dob[4] + dob[5]; break; }
/* 4714 */                strdob = "" + dob[0] + dob[1] + "/" + dob[2] + dob[3] + "/19" + dob[4] + dob[5]; break;
/* 4715 */             }  if (dob[0] > '1')
/* 4716 */               strdob = "0" + dob[0] + "/0" + dob[1] + "/" + dob[2] + dob[3] + dob[4] + dob[5]; 
/*      */             break;
/*      */           case 7:
/* 4719 */             if (dob[0] > '1') { strdob = "0" + dob[0] + "/" + dob[1] + dob[2] + "/" + dob[3] + dob[4] + dob[5] + dob[6]; break; }
/* 4720 */              if (dob[1] >= '3') {
/* 4721 */               strdob = "0" + dob[0] + "/" + dob[1] + dob[2] + "/" + dob[3] + dob[4] + dob[5] + dob[6]; break;
/* 4722 */             }  strdob = "" + dob[0] + dob[1] + "/0" + dob[2] + "/" + dob[3] + dob[4] + dob[5] + dob[6]; break;
/*      */           case 8:
...
/* 4741 */       if (day.length() == 1) day = "0" + day;
/*      */       
/* 4743 */       String month = matcher.group(1);
/* 4744 */       if (month.length() == 1) month = "0" + month;
/*      */       
...
/* 4785 */     switch (src) { case "ln":
/* 4786 */         chkLn = validInd; go++;
/* 4787 */       case "fn": chkFn = (chkLn == 2) ? validInd : 2; go++;
/* 4788 */       case "id": if (go == 0) chkId = validInd;  chkDob = validateDobStr(this.std_dob); if (go == 0)
/* 4789 */           break; case "dob": if (chkDob == 3) { chkDob = validInd; chkId = validateLsuId(this.stud.getStudentALsuid()); }
/*      */         
/*      */         break; }
/*      */ 
/*      */     
/* 4794 */     if (chkLn > 1) chkLn = validateLn(this.std_ln); 
/* 4795 */     if (chkFn > 1) chkFn = validateFn(this.std_fn); 
/* 4796 */     if (chkId > 1) chkId = validateLsuId(this.stud.getStudentALsuid());
/*      */     
...
/*      */     
/* 4889 */     if (this.popups == null) this.popups = new ArrayList<>(); 
